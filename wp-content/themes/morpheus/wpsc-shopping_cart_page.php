      ...
      <?php if(wpsc_has_tnc()) : ?>
         ...
         <tr>
            <td colspan='2'>
                ...
                <label for="agree"><input id="agree" type='checkbox' value='yes' name='agree' /> <?php printf(__("I agree to the <a class='thickbox' target='_blank' href='%s' id='tnc_link'>Terms and Conditions</a>", "wpsc"), esc_url( home_url( "?termsandconds=true&amp;max-width:90%&amp;height=400" ) ) ); 
